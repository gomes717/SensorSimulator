...
| # | Title |
|---|---|
| 18 | MainWindow god object + seam leaks | **partial** — BoardLink + ConfigController seam + GlucoseGraph extracted (1583→1263); ~3 more mechanical splits to clear the C0302 1000-line gate |
